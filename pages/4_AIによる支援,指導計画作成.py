...
"""
            ...
            if is_excel_mode:
                # --- Excelモード: 指示内容はそのまま、出力だけJSONにする ---
...
{{
  "needs": "1.特別な教育的ニーズの全文（対象児童は...から配慮が必要である...まで全て）",
  "accommodations": "2.合理的配慮の実施内容の全文（箇条書きなど含む）"
}}
"""
            else:
                # --- 通常モード ---
