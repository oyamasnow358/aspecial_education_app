...
with col1:
    with st.container(border=True):
        ...
        # --- ▼ここを修正▼ ---
        st.button("この機能を使う", on_click=set_page, args=("pages/1_📚_指導支援内容.py",), key="btn_guidance")
        # --- ▲ここまで修正▲ ---
    ...
    with st.container(border=True):
        ...
        # --- ▼ここを修正▼ ---
        st.button("この機能を使う", on_click=set_page, args=("pages/3_📈_分析方法.py",), key="btn_analysis")
        # --- ▲ここまで修正▲ ---
...
with col2:
    with st.container(border=True):
        ...
        # --- ▼ここを修正▼ ---
        st.button("この機能を使う", on_click=set_page, args=("pages/2_📊_発達チャート作成.py",), key="btn_chart")
        # --- ▲ここまで修正▲ ---
    ...
    with st.container(border=True):
        ...
        # --- ▼ここを修正▼ ---
        st.button("この機能を使う", on_click=set_page, args=("pages/4_📝_フィードバック.py",), key="btn_feedback")
        # --- ▲ここまで修正▲ ---
