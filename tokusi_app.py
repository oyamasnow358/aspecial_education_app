...
def load_css():
    ...
    <style>
        ...
        /* 
           ================================================================
           ★ 機能カードの「枠線」と「境界」を強制的に修正 ★
           ================================================================
        */
        
        /* Streamlitのコンテナ(枠)を特定してスタイルを上書き */
        [data-testid="column"] [data-testid="stBorderContainer"] {{
            /* 枠線: 白ではっきり描画 */
        ...
        /* ホバー時の動き (少し浮いて枠が青くなる) */
        [data-testid="column"] [data-testid="stBorderContainer"]:hover {{
