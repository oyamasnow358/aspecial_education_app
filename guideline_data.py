...
（イ）　乾電池と豆電球などをつないだときの様子について調べる中で，差異点や共通点に気付き，電気の回路についての疑問をもち，表現すること。
                    "指導計画の作成と内容の取扱い": ア　（２）の「Ａ生命」のアの「身の回りの生物」については，次のとおり取り扱うものとする。
...
（イ）　水や空気の体積や状態の変化について調べる中で，見いだした疑問について，既習の内容や生活経験を基に予想し，表現すること。
                    ...
                    "指導計画の作成と内容の取扱い": ア　（２）の「Ａ生命」のアの「人の体のつくりと運動」のアの については，関節の働きを扱うものとすること。
イ　（２）の「Ａ生命」のイの「季節と生物」については，１年を通しての動物の活動や植物の成長を観察や映像資料などで指導するものとする。
ウ　（２）の「Ｂ地球・自然」のイの「天気の様子」のアの については，２つのデータを同時に扱うようなグラフや表は扱わないこと。"""
                            },
                "指導計画の作成と内容の取扱い": """１）　指導計画の作成に当たっては，次の事項に配慮するものとする。
...
キ　オリンピック・パラリンピックなどとも関連させ，フェアなプレイを大切にするなど，生徒の発達の段階に応じて，運動やスポーツの大切さや必要性等に触れるようにするとともに，運動やスポーツを「すること」，「知ること」，「見ること」，「応援すること」などの多様な関わり方について取り扱うようにすること。"""
            ...
            "職業・家庭": {
                "目標": """生活の営みに係る見方・考え方や職業の見方・考え方を働かせ，生活や職業に関する実践的・体験的な学習活動を通して，よりよい生活の実現に向けて工夫する資質・能力を次のとおり育成することを目指す。
...
（オ）　「Ｂ情報機器の活用」については，家庭生活における情報機器の取扱いについても留意して指導すること。
ウ　家庭分野
...
（ケ）社会的事象については，生徒の考えが深まるよう様々な見解を提示するよう配慮し，多様な見解のある事柄，未確定な事柄を取り上げる場合には，有益適切な教材に基づいて指導するとともに，特定の事柄を強調し過ぎたり，一面的な見解を十分な配慮なく取り上げたりするなどの偏った取扱いにより，生徒が多角的に考えたり，事実を客観的に捉え，公正に判断したりすることを妨げることのないよう留意すること。"""
            ...
            "数学科": {
                ...
                "１段階": {
                    "目標": {
                        "Ａ 数と計算": "ア 整数，小数，分数及び概数の意味と表し方や四則の関係について理解するとともに，整数，小数及び分数の計算についての意味や性質について理解し，それらを計算する技能を身に付けるようにする。\nイ 数の表し方の仕組みや数を構成する単位に着目し，数の比べ方や表し方を統合的に捉えて考察したり，数とその表現や数量の関係に着目し，目的に合った表現方法を用いて計算の仕方を考察したりするとともに，数量の関係を簡潔に，また一般的に表現する力を養う。\nウ 数量について数学的に表現・処理したことを振り返り，多面的に捉え検討してよりよいものを求めて粘り強く考える態度，数学のよさに気付き学習したことを生活や学習に活用しようとする態度を養う。",
                        "Ｂ 図形": "ア 図形の形や大きさが決まる要素や立体を構成する要素の位置関係，図形の合同や多角形の性質について理解し，図形を作図したり，三角形，平行四辺形，ひし形，台形の面積を求めたりする技能を身に付けるようにする。\nイ 図形を構成する要素や図形間の関係に着目し，構成の仕方を考察したり，図形の性質を見いだし統合的に考察したりするとともに，三角形，平行四辺形，ひし形の面積の求め方を考え，その表現を振り返り，簡潔かつ的確な表現に高め，公式として導く力を養う。\nウ 図形や数量について数学的に表現・処理したことを振り返り，多面的に捉え検討してよりよいものを求めて粘り強く考える態度，数学のよさに気付き学習したことを生活や学習に活用しようとする態度を養う。",
                        "Ｃ 変化と関係": "ア 比例の関係や異種の二つの量の割合として捉えられる数量の比べ方，百分率について理解するとともに，目的に応じてある二つの数量の関係と別の二つの数量とを比べたり，表現したりする方法についての技能を身に付けるようにする。\nイ 伴って変わる二つの数量の関係に着目し，その変化や対応の特徴を表や式を用いて考察したり，異種の二つの量の割合を用いた数量の比べ方を考察したりする力を養う。\nウ 数量について数学的に表現・処理したことを振り返り，多面的に捉え検討してよりよいものを求めて粘り強く考える態度，数学のよさに気付き学習したことを生活や学習に活用しようとする態度を養う。",
                        "Ｄ データの活用": "ア データを円グラフや帯グラフで表す表し方や読み取り方，測定した結果を平均する方法について理解するとともに，それらの問題解決における用い方についての技能を身に付けるようにする。\nイ 目的に応じてデータを収集し，データの特徴や傾向に着目して，表やグラフに的確に表現し，それらを用いて問題解決したり，解決の過程や結果を多面的に捉え考察したりする力を養う。\nウ データの活用について数学的に表現・処理したことを振り返り，多面的に捉え検討してよりよいものを求めて粘り強く考える態度，数学のよさに気付き学習したことを生活や学習に活用しようとする態度を養う。"
                    },
                    "内容": {
                        "Ａ 数と計算": {
                            "ア 整数の表し方に関わる数学的活動を通して，次の事項を身に付けることができるよう指導する。": {
                                "知識及び技能": "万の単位を知ること。10 倍，100 倍，1000 倍， 1/10 の大きさの数及びその表し方の理解を深めること。\n億，兆の単位について知り，十進位取り記数法についての理解を深めること。",
                                "思考力，判断力，表現力等": "数のまとまりに着目し，大きな数の大きさの比べ方や表し方を統合的に捉えるとともに，それらを日常生活に生かすこと。"
                            },
                            "イ 整数及び小数の表し方に関わる数学的活動を通して，次の事項を身に付けることができるよう指導する。": {
                                "知識及び技能": "ある数の 10 倍，100 倍，1000 倍， 1/10 ， 1/100 などの大きさの数を，小数点の位置を移してつくること。",
                                "思考力，判断力，表現力等": "数の表し方の仕組みに着目し，数の相対的な大きさを考察し，計算などに有効に生かすこと。"
                            },
                            "ウ 概数に関わる数学的活動を通して，次の事項を身に付けることができるよう指導する。": {
                                "知識及び技能": "概数が用いられる場面について知ること。\n四捨五入について知ること。\n目的に応じて四則計算の結果の見積りをすること。",
                                "思考力，判断力，表現力等": "日常の事象における場面に着目し，目的に合った数の処理の仕方を考えるとともに，それを日常生活に生かすこと。"
                            },
                            "エ 整数の加法及び減法に関わる数学的活動を通して，次の事項を身に付けることができるよう指導する。": {
                                "知識及び技能": "大きな数の加法及び減法の計算が，２位数などについての基本的な計算を基にしてできることを理解すること。また，その筆算の仕方について理解すること。\n加法及び減法の計算が確実にでき，それらを適切に用いること。",
                                "思考力，判断力，表現力等": "数量の関係に着目し，計算の仕方を考えたり，計算に関して成り立つ性質を見いだしたりするとともに，その性質を活用して，計算を工夫したり，計算の確かめをしたりすること。"
                            },
                            "オ 整数の乗法に関わる数学的活動を通して，次の事項を身に付けることができるよう指導する。": {
                                "知識及び技能": "２位数や３位数に１位数や２位数をかける乗法の計算が，乗法九九などの基本的な計算を基にしてできることを理解すること。また，その筆算の仕方について理解すること。\n乗法の計算が確実にでき，それを適切に用いること。\n乗法に関して成り立つ性質について理解すること。",
                                "思考力，判断力，表現力等": "数量の関係に着目し，計算の仕方を考えたり，計算に関して成り立つ性質を見いだしたりするとともに，その性質を活用して，計算を工夫したり，計算の確かめをしたりすること。"
                            },
                            "カ 整数の除法に関わる数学的活動を通して，次の事項を身に付けることができるよう指導する。": {
                                "知識及び技能": "除数が１位数や２位数で被除数が２位数や３位数の場合の計算が，基本的な計算を基にしてできることを理解すること。また，その筆算の仕方について理解すること。\n除法の計算が確実にでき，それを適切に用いること。\n除法について，次の関係を理解すること。\n（被除数）＝（除数）×（商）＋（余り）\n除法に関して成り立つ性質について理解すること。",
                                "思考力，判断力，表現力等": "数量の関係に着目し，計算の仕方を考えたり，計算に関して成り立つ性質を見いだしたりするとともに，その性質を活用して，計算を工夫したり，計算の確かめをしたりすること。"
                            },
                            "キ 小数とその計算に関わる数学的活動を通して，次の事項を身に付けることができるよう指導する。": {
                                "知識及び技能": "ある量の何倍かを表すのに小数を用いることを知ること。\n小数が整数と同じ仕組みで表されていることを知るとともに，数の相対的な大きさについての理解を深めること。\n小数の加法及び減法の意味について理解し，それらの計算ができること。\n乗数や除数が整数である場合の小数の乗法及び除法の計算ができること。",
                                "思考力，判断力，表現力等": "数の表し方の仕組みや数を構成する単位に着目し，計算の仕方を考えるとともに，それを日常生活に生かすこと。"
                            },
                            "ク 小数の乗法及び除法に関わる数学的活動を通して，次の事項を身に付けることができるよう指導する。": {
                                "知識及び技能": "乗数や除数が小数である場合の小数の乗法及び除法の意味について理解すること。\n小数の乗法及び除法の計算ができること。\n余りの大きさについて理解すること。\n小数の乗法及び除法についても整数の場合と同じ関係や法則が成り立つことを理解すること。",
                                "思考力，判断力，表現力等": "乗法及び除法の意味に着目し，乗数や除数が小数である場合まで数の範囲を広げて乗法及び除法の意味を捉え直すとともに，それらの計算の仕方を考えたり，それらを日常生活に生かしたりすること。"
                            },
                            "ケ 分数とその計算に関わる数学的活動を通して，次の事項を身に付けることができるよう指導する。": {
                                "知識及び技能": "等分してできる部分の大きさや端数部分の大きさを表すのに分数を用いることについて理解すること。また，分数の表し方について知ること。\n分数が単位分数の幾つ分かで表すことができることを知ること。\n簡単な場合について，分数の加法及び減法の意味について理解し，それらの計算ができることを知ること。\n簡単な場合について，大きさの等しい分数があることを知ること。\n同分母の分数の加法及び減法の計算ができること。",
                                "思考力，判断力，表現力等": "数のまとまりに着目し，分数でも数の大きさを比べたり，計算したりできるかどうかを考えるとともに，分数を日常生活に生かすこと。\n数を構成する単位に着目し，大きさの等しい分数を探したり，計算の仕方を考えたりするとともに，それを日常生活に生かすこと。"
                            },
                            "コ 数量の関係を表す式に関わる数学的活動を通して，次の事項を身に付けることができるよう指導する。": {
                                "知識及び技能": "四則の混合した式や（ ）を用いた式について理解し，正しく計算すること。\n公式についての考え方を理解し，公式を用いること。\n数量を□，△などを用いて表し，その関係を式に表したり，□，△などに数を当てはめて調べたりすること。\n数量の関係を表す式についての理解を深めること。",
                                "思考力，判断力，表現力等": "問題場面の数量の関係に着目し，数量の関係を簡潔に，また一般的に表現したり，式の意味を読み取ったりすること。\n二つの数量の対応や変わり方に着目し，簡単な式で表されている関係について考察すること。"
                            },
                            "サ 計算に関して成り立つ性質に関わる数学的活動を通して，次の事項を身に付けることができるよう指導する。": {
                                "知識及び技能": "四則に関して成り立つ性質についての理解を深めること。",
                                "思考力，判断力，表現力等": "数量の関係に着目し，計算に関して成り立つ性質を用いて計算の仕方を考えること。"
                            }
                        },
                        "Ｂ 図形": {
                            "ア 平面図形に関わる数学的活動を通して，次の事項を身に付けることができるよう指導する。": {
                                "知識及び技能": "平行四辺形，ひし形，台形について知ること。\n図形の形や大きさが決まる要素について理解するとともに，図形の合同について理解すること。\n三角形や四角形など多角形についての簡単な性質を理解すること。\n円と関連させて正多角形の基本的な性質を知ること。\n円周率の意味について理解し，それを用いること。",
                                "思考力，判断力，表現力等": "図形を構成する要素及びそれらの位置関係に着目し，構成の仕方を考察し図形の性質を見いだすとともに，その性質を基に既習の図形を捉え直すこと。\n図形を構成する要素及び図形間の関係に着目し，構成の仕方を考察したり，図形の性質を見いだし，その性質を筋道を立てて考え説明したりすること。"
                            },
                            "イ 立体図形に関わる数学的活動を通して，次の事項を身に付けることができるよう指導する。": {
                                "知識及び技能": "立方体，直方体について知ること。\n直方体に関連して，直線や平面の平行や垂直の関係について理解すること。\n見取図，展開図について知ること。\n基本的な角柱や円柱について知ること。",
                                "思考力，判断力，表現力等": "図形を構成する要素及びそれらの位置関係に着目し，立体図形の平面上での表現や構成の仕方を考察し，図形の性質を見いだすとともに，日常の事象を図形の性質から捉え直すこと。"
                            },
                            "ウ ものの位置に関わる数学的活動を通して，次の事項を身に付けることができるよう指導する。": {
                                "知識及び技能": "ものの位置の表し方について理解すること。",
                                "思考力，判断力，表現力等": "平面や空間における位置を決める要素に着目し，その位置を数を用いて表現する方法を考察すること。"
                            },
                            "エ 平面図形の面積に関わる数学的活動を通して，次の事項を身に付けることができるよう指導する。": {
                                "知識及び技能": "三角形，平行四辺形，ひし形，台形の面積の計算による求め方について理解すること。",
                                "思考力，判断力，表現力等": "図形を構成する要素などに着目して，基本図形の面積の求め方を見いだすとともに，その表現を振り返り，簡潔かつ的確な表現に高め，公式として導くこと。"
                            }
                        },
                        "Ｃ 変化と関係": {
                            "ア 伴って変わる二つの数量に関わる数学的活動を通して，次の事項を身に付けることができるよう指導する。": {
                                "知識及び技能": "簡単な場合について，比例の関係があることを知ること。",
                                "思考力，判断力，表現力等": "伴って変わる二つの数量を見いだして，それらの関係に着目し，表や式を用いて変化や対応の特徴を考察すること。"
                            },
                            "イ 異種の二つの量の割合として捉えられる数量に関わる数学的活動を通して，次の事項を身に付けることができるよう指導する。": {
                                "知識及び技能": "速さなど単位量当たりの大きさの意味及び表し方について理解し，それを求めること。",
                                "思考力，判断力，表現力等": "異種の二つの量の割合として捉えられる数量の関係に着目し，目的に応じて大きさを比べたり，表現したりする方法を考察し，それらを日常生活に生かすこと。"
                            },
                            "ウ 二つの数量の関係に関わる数学的活動を通して，次の事項を身に付けることができるよう指導する。": {
                                "知識及び技能": "ある二つの数量関係と別の二つの数量の関係を比べる場合に割合を用いる場合があることを理解すること。\n百分率を用いた表し方を理解し，割合などを求めること。",
                                "思考力，判断力，表現力等": "日常の事象における数量の関係に着目し，図や式などを用いて，ある二つの数量の関係と別の二つの数量の関係との比べ方を考察し，それを日常生活に生かすこと。"
                            }
                        },
                        "Ｄ データの活用": {
                            "ア データの収集とその分析に関わる数学的活動を通して，次の事項を身に付けることができるよう指導する。": {
                                "知識及び技能": "数量の関係を割合で捉え，円グラフや帯グラフで表したり，読んだりすること。\n円グラフや帯グラフの意味やそれらの用い方を理解すること。\nデータの収集や適切な手法の選択など統計的な問題解決の方法を知ること。",
                                "思考力，判断力，表現力等": "目的に応じてデータを集めて分類整理し，データの特徴や傾向に着目し，問題を解決するために適切なグラフを選択して読み取り，その結論について多面的に捉え考察すること。"
                            },
                            "イ 測定した結果を平均する方法に関わる数学的活動を通して，次の事項を身に付けることができるよう指導する。": {
                                "知識及び技能": "平均の意味や求め方を理解すること。",
                                "思考力，判断力，表現力等": "概括的に捉えることに着目し，測定した結果を平均する方法について考察し，それを学習や日常生活に生かすこと。"
                            }
                        },
                        "数学的活動": {
                            "ア 内容の「Ａ数と計算」，「Ｂ図形」，「Ｃ変化と関係」及び「Ｄデータの活用」に示す学習については，次のような数学的活動に取り組むものとする。": "( ｱ ) 日常の事象から数学の問題を見いだして解決し，結果を確かめたり，日常生活等に生かしたりする活動\n( ｲ ) 数学の学習場面から数学の問題を見いだして解決し，結果を確かめたり，発展的に考察したりする活動\n( ｳ ) 問題解決の過程や結果を，図や式などを用いて数学的に表現し伝え合う活動"
                        }
                    }
                },
                "２段階": {
                    "目標": {
                        "Ａ 数と計算": "ア 整数の性質，分数の意味，文字を用いた式について理解するとともに，分数の計算についての意味や法則について理解し，それらを計算する技能を身に付けるようにする。\nイ 数とその表現や計算の意味に着目し，発展的に考察して問題を見いだしたり，目的に応じて多様な表現方法を用いながら，数の表し方や計算の仕方などを考察したりするとともに，数量の関係を簡潔かつ一般的に表現する力を養う。\nウ 数量について数学的に表現・処理したことを振り返り，多面的に捉え検討してよりよいものを求めて粘り強く考える態度，数学のよさを実感し，学習したことを生活や学習に活用しようとする態度を養う。",
                        "Ｂ 図形": "ア 平面図形を縮小したり，拡大したりすることの意味や，立体図形の体積の求め方について理解し，縮図，拡大図を作図したり，円の面積や立方体，直方体，角柱，円柱の体積を求めたりする技能を身に付けるようにする。\nイ 図形を構成する要素や図形間の関係に着目し，構成の仕方を考察したり，図形の性質を見いだしたりするとともに，円の面積や立方体，直方体，角柱，円柱の体積の求め方を考え，その表現を振り返り，簡潔かつ的確な表現に高め，公式として導く力を養う。\nウ 図形や数量について数学的に表現・処理したことを振り返り，多面的に捉え検討してよりよいものを求めて粘り強く考える態度，数学のよさを実感し，学習したことを生活や学習に活用しようとする態度を養う。",
                        "Ｃ 変化と関係": "ア 比例や反比例の関係，比について理解するとともに，伴って変わる二つの数量を見いだし，それらの関係について表や式を用いて表現したり，目的に応じて比で処理したりする方法についての技能を身に付けるようにする。\nイ 伴って変わる二つの数量の関係に着目し，目的に応じて表や式，グラフを用いて変化や対応の特徴を考察したり，比例の関係を前提に二つの数量の関係を考察したりする力を養う。\nウ 数量について数学的に表現・処理したことを振り返り，多面的に捉え検討してよりよいものを求めて粘り強く考える態度，数学のよさを実感し，学習したことを生活や学習に活用しようとする態度を養う。",
                        "Ｄ データの活用": "ア 量的データの分布の中心や散らばりの様子からデータの特徴を読み取る方法を理解するとともに，それらを問題解決における用い方についての技能を身に付けるようにする。\nイ 目的に応じてデータを収集し，データの特徴や傾向に着目して，表やグラフに的確に表現し，それらを用いて問題解決したり，解決の過程や結果を批判的に捉え考察したりする力を養う。\nウ データの活用について数学的に表現・処理したことを振り返り，多面的に捉え検討してよりよいものを求めて粘り強く考える態度，数学のよさを実感し，学習したことを生活や学習に活用しようとする態度を養う。"
                    },
                    "内容": {
                        "Ａ 数と計算": {
                            "ア 整数の性質及び整数の構成に関わる数学的活動を通して，次の事項を身に付けることができるよう指導する。": {
                                "知識及び技能": "整数は，観点を決めると偶数と奇数に類別されることを理解すること。\n約数，倍数について理解すること。",
                                "思考力，判断力，表現力等": "乗法及び除法に着目し，観点を決めて整数を類別する仕方を考えたり，数の構成について考察したりするとともに，日常生活に生かすこと。"
                            },
                            "イ 分数に関わる数学的活動を通して，次の事項を身に付けることができるよう指導する。": {
                                "知識及び技能": "整数及び小数を分数の形に直したり，分数を小数で表したりすること。\n整数の除法の結果は，分数を用いると常に一つの数として表すことができることを理解すること。\n一つの分数の分子及び分母に同じ数を乗除してできる分数は，元の分数と同じ大きさを表すことを理解すること。\n分数の相等及び大小について知り，大小を比べること。",
                                "思考力，判断力，表現力等": "数を構成する単位に着目し，数の相等及び大小関係について考察すること。\n分数の表現に着目し，除法の結果の表し方を振り返り，分数の意味をまとめること。"
                            },
                            "ウ 分数の加法及び減法に関わる数学的活動を通して，次の事項を身に付けることができるよう指導する。": {
                                "知識及び技能": "異分母の分数の加法及び減法の計算ができること。",
                                "思考力，判断力，表現力等": "分数の意味や表現に着目し，計算の仕方を考えること。"
                            },
                            "エ 分数の乗法及び除法に関わる数学的活動を通して，次の事項を身に付けることができるよう指導する。": {
                                "知識及び技能": "乗数や除数が整数や分数である場合も含めて，分数の乗法及び除法の意味について理解すること。\n分数の乗法及び除法の計算ができること。\n分数の乗法及び除法についても，整数の場合と同じ関係や法則が成り立つことを理解すること。",
                                "思考力，判断力，表現力等": "数の意味と表現，計算について成り立つ性質に着目し，計算の仕方を多面的に捉え考えること。"
                            },
                            "オ 数量の関係を表す式に関わる数学的活動を通して，次の事項を身に付けることができるよう指導する。": {
                                "知識及び技能": "数量を表す言葉や□，△などの代わりに，a ，x などの文字を用いて式に表したり，文字に数を当てはめて調べたりすること。",
                                "思考力，判断力，表現力等": "問題場面の数量の関係に着目し，数量の関係を簡潔かつ一般的に表現したり，式の意味を読み取ったりすること。"
                            }
                        },
                        "Ｂ 図形": {
                            "ア 平面図形に関わる数学的活動を通して，次の事項を身に付けることができるよう指導する。": {
                                "知識及び技能": "縮図や拡大図について理解すること。\n対称な図形について理解すること。",
                                "思考力，判断力，表現力等": "図形を構成する要素及び図形間の関係に着目し，構成の仕方を考察したり，図形の性質を見いだしたりするとともに，その性質を基に既習の図形を捉え直したり，日常生活に生かしたりすること。"
                            },
                            "イ 身の回りにある形の概形やおよその面積などに関わる数学的活動を通して，次の事項を身に付けることができるよう指導する。": {
                                "知識及び技能": "身の回りにある形について，その概形を捉え，およその面積などを求めること。",
                                "思考力，判断力，表現力等": "図形を構成する要素や性質に着目し，筋道を立てて面積などの求め方を考え，それを日常生活に生かすこと。"
                            },
                            "ウ 平面図形の面積に関わる数学的活動を通して，次の事項を身に付けることができるよう指導する。": {
                                "知識及び技能": "円の面積の計算による求め方について理解すること。",
                                "思考力，判断力，表現力等": "図形を構成する要素などに着目し，基本図形の面積の求め方を見いだすとともに，その表現を振り返り，簡潔かつ的確な表現に高め，公式として導くこと。"
                            },
                            "エ 立体図形の体積に関わる数学的活動を通して，次の事項を身に付けることができるよう指導する。": {
                                "知識及び技能": "体積の単位（立方センチメートル（㎝3），立方メートル（m3））について理解すること。\n立方体及び直方体の体積の計算による求め方について理解すること。\n基本的な角柱及び円柱の体積の計算による求め方について理解すること。",
                                "思考力，判断力，表現力等": "体積の単位や図形を構成する要素に着目し，図形の体積の求め方を考えるとともに，体積の単位とこれまでに学習した単位との関係を考察すること。\n図形を構成する要素に着目し，基本図形の体積の求め方を見いだすとともに，その表現を振り返り，簡潔かつ的確な表現に高め，公式として導くこと。"
                            }
                        },
                        "Ｃ 変化と関係": {
                            "ア 伴って変わる二つの数量に関わる数学的活動を通して，次の事項を身に付けることができるよう指導する。": {
                                "知識及び技能": "比例の関係の意味や性質を理解すること。\n比例の関係を用いた問題解決の方法について理解すること。\n反比例の関係について理解すること。",
                                "思考力，判断力，表現力等": "伴って変わる二つの数量を見いだして，それらの関係に着目し，目的に応じて表や式，グラフを用いてそれらの関係を表現して，変化や対応の特徴を見いだすとともに，それらを日常生活に生かすこと。"
                            },
                            "イ 二つの数量の関係に関わる数学的活動を通して，次の事項を身に付けることができるよう指導する。": {
                                "知識及び技能": "比の意味や表し方を理解し，数量の関係を比で表したり，等しい比をつくったりすること。",
                                "思考力，判断力，表現力等": "日常の事象における数量の関係に着目し，図や式などを用いて数量の関係の比べ方を考察し，それを日常生活に生かすこと。"
                            }
                        },
                        "Ｄ データの活用": {
                            "ア データの収集とその分析に関わる数学的活動を通して，次の事項を身に付けることができるよう指導する。": {
                                "知識及び技能": "代表値の意味や求め方を理解すること。\n度数分布を表す表や柱状グラフの特徴及びそれらの用い方を理解すること。\n目的に応じてデータを収集したり，適切な手法を選択したりするなど，統計的な問題解決の方法を理解すること。",
                                "思考力，判断力，表現力等": "目的に応じてデータを集めて分類整理し，データの特徴や傾向に着目し，代表値などを用いて問題の結論について判断するとともに，その妥当性について批判的に考察すること。"
                            },
                            "イ 起こり得る場合に関わる数学的活動を通して，次の事項を身に付けることができるよう指導する。": {
                                "知識及び技能": "起こり得る場合を順序よく整理するための図や表などの用い方を理解すること。",
                                "思考力，判断力，表現力等": "事象の特徴に着目し，順序よく整理する観点を決めて，落ちや重なりなく調べる方法を考察すること。"
                            }
                        },
                        "数学的活動": {
                            "ア 内容の「Ａ数と計算」，「Ｂ図形」，「Ｃ変化と関係」及び「Ｄデータの活用」の学習やそれらを相互に関連付けた学習において，次のような数学的活動に取り組むものとする。": "( ｱ ) 日常の事象を数理的に捉え，問題を見いだして解決し，解決過程を振り返り，結果や方法を改善したり，日常生活等に生かしたりする活動\n( ｲ ) 数学の学習場面から数学の問題を見いだして解決し，解決過程を振り返り統合的・発展的に考察する活動\n( ｳ ) 問題解決の過程や結果を，目的に応じて図や式などを用いて数学的に表現し伝え合う活動"
                        }
                    }
                },
                "指導計画の作成と内容の取扱い": "(1) 指導計画の作成に当たっては，次の事項に配慮するものとする。\nア 単元など内容や時間のまとまりを見通して，その中で育むべき資質・能力の育成に向けて，数学的活動を通して，生徒の主体的・対話的で深い学びの実現を図るようにすること。その際，数学的な見方・考え方を働かせながら，日常の事象を数学的に捉え，数学の問題を見いだし，問題を自立的，協働的に解決し，学習の過程を振り返り，概念を形成するなどの学習の充実を図ること。\nイ 数量や図形についての基礎的な能力の維持や向上を図るため，適宜練習の機会を設けて計画的に指導すること。また，段階間の指導内容を円滑に接続させるため，適切な反復による学習指導を進めるようにすること。\nウ ２の内容の「Ａ数と計算」，「Ｂ図形」，「Ｃ変化と関係」及び「Ｄデータの活用」の指導の間の関連を図ること。\n(2) ２の各段階の内容の取扱いについては，次の事項に配慮するものとする。\n① 「ア思考力，判断力，表現力等を育成するため，各段階の内容の指導に当たっては，具体物，図，言葉，数，式，表，グラフなどを用いて考えたり，数学的な表現を用いて説明したり，互いに自分の考えを表現し伝え合ったりするなどの学習活動を積極的に取り入れるようにすること」とは，図，数，式，表，グラフといった数学的な表現の方法について学ぶとともに，それらを活用する指導について工夫することである。\n② 「イ「Ａ数と計算」の指導に当たっては，次の( ｱ )及び( ｲ )について留意するものとする」とは，生徒が行動を通して具体物などの教具や計算機を扱うことによって，また，他教科との関連を図りながら数を取り扱うことによって，考えることの楽しさや大切さに気付くようにしていくということである。\n③ 「ウ１段階の内容に示す事項については，次の( ｱ )から（シ）までに留意するものとする」とは，指導に当たって検討すべき観点のことである。\nなお，「( ｱ )内容の「Ａ数と計算」のア，イ，エ，オ及びカについては，職業科や家庭科との関連を図りながら，次の㋐についての金銭の価値や処理に親しむことを取り扱うものとする」については，他教科との関連を図りながら，生徒の数の理解に配慮し，金銭処理に関する指導を行うようにすることである。例えば，整数の表し方について，４位数までの十進位取り記数法による数の表し方及び数の大小や順序についての理解（中学部２段階）が進んでいる生徒に対して，いろいろな金種を組み合わせて，おつりのある買い物をすることができるよう，値段と代金とおつりとの関係を理解し，深めていくことである。金銭の処理の仕方については，値段にちょうどのお金を用意する場合であれば，値段を示す４位数を理解し，両替の考え方（例えば，千円札を百円硬貨 10 枚，百円硬貨を十円硬貨 10 枚に置き換えること。五百円硬貨や五十円硬貨などを，百円硬貨や十円硬貨５枚に置き換えること）を活用して，同じ価値のお金を，色々な金種を組み合わせて用意することである。また，値段に対して価値が少し大きいお金（例えば，値段が 1,374 円のときの 1,380 円や 1,400 円，1,500 円など，きりのよい代金のこと）を用意することである。\n④ 「エ２段階の内容に示す事項については，次の( ｱ )から( ｵ )までに留意するものとする」とは，指導に当たって検討すべき観点のことである。\n(3) 数学的活動の指導に当たっては，次の事項に配慮するものとする。\nア 数学的活動は，基礎的・基本的な知識及び技能を確実に身に付けたり，思考力，判断力，表現力等を高めたり，数学を学ぶことの楽しさや意義を実感したりするために，重要な役割を果たすものであることから，２の内容の「Ａ数と計算」，「Ｂ図形」，「Ｃ変化と関係」及び「Ｄデータの活用」に示す事項については，数学的活動を通して指導するようにすること。\nイ 数学的活動を楽しめるようにするとともに，数学を生活に活用することなどについて実感する機会を設けること。\n① 「ア数学的活動は，基礎的・基本的な知識及び技能を確実に身に付けたり，思考力，判断力，表現力等を高めたり，数学を学ぶことの楽しさを実感したりするために，重要な役割を果たすものであることから，２の内容の「Ａ数と計算」，「Ｂ図形」，「Ｃ変化と関係」及び「Ｄデータの活用」に示す事項については，数学的活動を通して指導するようにすること」とし，各領域に示す全ての事項において，数学的活動を通した指導を行う必要があるということである。\n② 「イ数学的活動を楽しめるようにするとともに，数学を生活に活用することなどについて実感する機会を設けること」とは，数学を学ぶことの楽しさや意義を実感できるようにすることであり，生徒が目的意識をもって主体的に取り組む意欲を生活の中に広げていくことである。そのためには，数学的活動を通して，生徒が目的意識をもって主体的に取り組み，数学に関わりのある様々な活動を行う必要があるということである。"
            },
  ...
  "理科": {
      ...
      "１段階": {
          ...
          "内容": """
              A 生命: 
                  ア 植物の発芽，成長，結実: ( ｱ ) 次のことを理解するとともに，観察，実験などに関する初歩的な技能を身に付けること。\n㋐ 植物は，種子の中の養分を基にして発芽すること。\n㋑ 植物の発芽には，水，空気及び温度が関係していること。\n㋒ 植物の成長には，日光や肥料などが関係していること。\n㋓ 花にはおしべやめしべなどがあり，花粉がめしべの先に付くとめしべのもとが実になり，実の中に種子ができること。\n( ｲ ) 植物の育ち方について調べる中で，植物の発芽，成長及び結実とそれらに関わる条件についての予想や仮説を基に，解決の方法を考え，表現すること。,
                  内容の取扱い (植物の発芽，成長，結実): ア (2)の「Ａ生命」のアの「植物の発芽，成長，結実」については，次のとおり取り扱うものとする。\n( ｱ ) ( ｱ )の㋐の「種子の中の養分」については，でんぷんを扱うこと。\n( ｲ ) ( ｱ )の㋓については，おしべ，めしべ，がく及び花びらを扱うこと。また，受粉については，風や昆虫などが関係していることにも触れること。,
                  イ 動物の誕生: ( ｱ ) 次のことを理解するとともに，観察，実験などに関する初歩的な技能を身に付けること。\n㋐ 魚には雌雄があり，生まれた卵は日がたつにつれて中の様子が変化してかえること。\n㋑ 人は，母体内で成長して生まれること。\n( ｲ ) 動物の発生や成長について調べる中で，動物の発生や成長の様子と経過についての予想や仮説を基に，解決の方法を考え，表現すること。,
                  内容の取扱い (動物の誕生): イ (2)の「Ａ生命」のイの「動物の誕生」の( ｱ )の㋑については，人の受精に至る過程は取り扱わないこと。
                        
               B 地球・自然: 
                   ア 流れる水の働きと土地の変化: ( ｱ ) 次のことを理解するとともに，観察，実験などに関する初歩的な技能を身に付けること。\n㋐ 流れる水には，土地を侵食したり，石や土などを運搬したり堆積させたりする働きがあること。\n㋑ 川の上流と下流によって，川原の石の大きさや形に違いがあること。\n㋒ 雨の降り方によって，流れる水の速さや量は変わり，増水により土地の様子が大きく変化する場合があること。\n( ｲ ) 流れる水の働きについて調べる中で，流れる水の働きと土地の変化との関係についての予想や仮説を基に，解決の方法を考え，表現すること。,
                   内容の取扱い (流れる水の働きと土地の変化): ウ (2)の「Ｂ地球・自然」のアの「流れる水の働きと土地の変化」の( ｱ )の㋒については，自然災害についても触れること。,
                  イ 天気の変化: ( ｱ ) 次のことを理解するとともに，観察，実験などに関する初歩的な技能を身に付けること。\n㋐ 天気の変化は，雲の量や動きと関係があること。\n㋑ 天気の変化は，映像などの気象情報を用いて予想できること。\n( ｲ ) 天気の変化の仕方について調べる中で，天気の変化の仕方と雲の量や動きとの関係についての予想や仮説を基に，解決の方法を考え，表現すること。,
                  内容の取扱い (天気の変化): エ (2)の「Ｂ地球・自然」のイの「天気の変化」の( ｱ )の㋑については，台風の進路による天気の変化や台風と降雨との関係及びそれに伴う自然災害についても触れること。
                        
               C 物質・エネルギー:
                   ア 物の溶け方: ( ｱ ) 次のことを理解するとともに，観察，実験などに関する初歩的な技能を身に付けること。\n㋐ 物が水に溶けても，水と物とを合わせた重さは変わらないこと。\n㋑ 物が水に溶ける量には，限度があること。\n㋒ 物が水に溶ける量は水の温度や量，溶ける物によって違うこと。また，この性質を利用して，溶けている物を取り出すことができること。\n( ｲ ) 物の溶け方について調べる中で，物の溶け方の規則性についての予想や仮説を基に，解決の方法を考え，表現すること。,
                  内容の取扱い (物の溶け方): カ (2)の「Ｃ物質・エネルギー」のアの「物の溶け方」については，水溶液の中では，溶けている物が均一に広がることにも触れること。,
                  イ 電流の働き: ( ｱ ) 次のことを理解するとともに，観察，実験などに関する初歩的な技能を身に付けること。\n㋐ 乾電池の数やつなぎ方を変えると，電流の大きさや向きが変わり，豆電球の明るさやモーターの回り方が変わること。\n( ｲ ) 電流の働きについて調べる中で，電流の大きさや向きと乾電池につないだ物の様子との関係についての予想や仮説を基に，解決の方法を考え，表現すること。,
                  内容の取扱い (電流の働き): キ (2)の「Ｃ物質・エネルギー」のイの「電流の働き」の( ｱ )の㋐については，直列つなぎと並列つなぎを扱うものとする。\nオ (2)の「Ｃ物質・エネルギー」の指導に当たっては，ものづくりを通して行うよう配慮すること。                                         
     """},
      "２段階": {
          "目標": """
            A 生命:ア 生物の体のつくりと働き，生物と環境との関わりについての理解を図り，観察，実験などに関する初歩的な技能を身に付けるようにする。\nイ 生物の体の体のつくりと働き，生物と環境との関わりについて調べる中で，主にそれらの働きや関わりについて，より妥当な考えをつくりだす力を養う。\nウ 生物の体のつくりと働き，生物と環境との関わりについて進んで調べ，生命を尊重する態度や学んだことを生活に生かそうとする態度を養う。,
            B 地球・自:ア 土地のつくりと変化，月の形の見え方と太陽との位置関係についての理解を図り，観察，実験などに関する初歩的な技能を身に付けるようにする。\nイ 土地のつくりと変化，月の形の見え方と太陽との位置関係について調べる中で，主にそれらの変化や関係について，より妥当な考えをつくりだす力を養う。\nウ 土地のつくりと変化，月の形の見え方と太陽との位置関係について進んで調べ，学んだことを生活に生かそうとする態度を養う。,
             C 物質・エネルギ:ア 燃焼の仕組み，水溶液の性質，てこの規則性及び電気の性質や働きについての理解を図り，観察，実験などに関する初歩的な技能を身に付けるようにする。\nイ 燃焼の仕組み，水溶液の性質，てこの規則性及び電気の性質や働きについて調べる中で，主にそれらの仕組みや性質，規則性及び働きについて，より妥当な考えをつくりだす力を養う。\nウ 燃焼の仕組み，水溶液の性質，てこの規則性及び電気の性質や働きについて進んで調べ，学んだことを生活に生かそうとする態度を養う。""",                    
           "内容": """
            A 生命: 
                  ア 人の体のつくりと働き": ( ｱ ) 次のことを理解するとともに，観察，実験などに関する初歩的な技能を身に付けること。\n㋐ 体内に酸素が取り入れられ，体外に二酸化炭素などが出されていること。\n㋑ 食べ物は，口，胃，腸などを通る間に消化，吸収され，吸収されなかった物は排出されること。\n㋒ 血液は，心臓の働きで体内を巡り，養分，酸素及び二酸化炭素などを運んでいること。\n㋓ 体内には，生命活動を維持するための様々な臓器があること。\n( ｲ ) 人や他の動物の体のつくりと働きについて調べる中で，体のつくりと呼吸，消化，排出及び循環の働きについて，より妥当な考えをつくりだし，表現すること。,
                  内容の取扱い (人の体のつくりと働き): ア (2)の「Ａ生命」のアの「人の体のつくりと働き」については，次のとおり取り扱うものとする。\n( ｱ ) ( ｱ )の㋒については，心臓の拍動と脈拍とが関係することにも触れること。\n( ｲ ) ( ｱ )の㋓については，主な臓器として，肺，胃，小腸，大腸，肝臓，腎臓，心臓を扱うこと。,
                  イ 植物の養分と水の通り道": ( ｱ ) 次のことを理解するとともに，観察，実験などに関する初歩的な技能を身に付けること。\n㋐ 植物の葉に日光が当たるとでんぷんができること。\n㋑ 根，茎及び葉には，水の通り道があり，根から吸い上げられた水は主に葉から蒸散により排出されること。\n( ｲ ) 植物の体のつくりと働きについて調べる中で，体のつくり，体内の水などの行方及び葉で養分をつくる働きについて，より妥当な考えをつくりだし，表現すること。,
                  ウ 生物と環境: ( ｱ ) 次のことを理解するとともに，観察，実験などに関する初歩的な技能を身に付けること。\n㋐ 生物は，水及び空気を通して周囲の環境と関わって生きていること。\n㋑ 生物の間には，食う食われるという関係があること。\n㋒ 人は，環境と関わり，工夫して生活していること。\n( ｲ ) 生物と環境について調べる中で，生物と環境との関わりについて，より妥当な考えをつくりだし，表現すること。,
                  内容の取扱い (生物と環境): イ (2)の「Ａ生命」のウの「生物と環境」については，次のとおり取り扱うものとする。\n( ｱ ) ( ｱ )の㋐については，水が循環していることにも触れること。\n( ｲ ) ( ｱ )の㋑ついては，水中の小さな生物を観察し，それらが魚などの食べ物になっていることに触れること。                        
              B 地球・自然: 
                  ア 土地のつくりと変化: ( ｱ ) 次のことを理解するとともに，観察，実験などに関する初歩的な技能を身に付けること。\n㋐ 土地は，礫れき，砂，泥，火山灰などからできており，層をつくって広がっているものがあること。また，層には化石が含まれているものがあること。\n㋑ 地層は，流れる水の働きや火山の噴火によってできること。\n㋒ 土地は，火山の噴火や地震によって変化すること。\n( ｲ ) 土地のつくりと変化について調べる中で，土地のつくりやでき方について，より妥当な考えをつくりだし，表現すること,
                  内容の取扱い (土地のつくりと変化): ウ (2)の「Ｂ地球・自然」のアの「土地のつくりと変化」については，次のとおり取り扱うものとする。\n( ｱ ) ( ｱ )の㋑については，流れる水の働きでできた岩石として礫れき岩，砂岩，泥岩を扱うこと。\n( ｲ ) ( ｱ )の㋒については，自然災害についても触れること。,
                  イ 月と太陽": ( ｱ ) 次のことを理解するとともに，観察，実験などに関する初歩的な技能を身に付けること。\n㋐ 月の輝いている側に太陽があること。また，月の形の見え方は，太陽と月との位置関係によって変わること。\n( ｲ ) 月の形の見え方について調べる中で，月の位置や形と太陽の位置との関係について，より妥当な考えをつくりだし，表現すること。,
                  内容の取扱い (月と太陽)": エ (2)の「Ｂ地球・自然」のイの「月と太陽」の( ｱ )の㋐については，地球から見た太陽と月との位置関係で扱うものとする。"                       
              C 物質・エネルギー: 
                   ア 燃焼の仕組み: ( ｱ ) 次のことを理解するとともに，観察，実験などに関する初歩的な技能を身に付けること。\n㋐ 植物体が燃えるときには，空気中の酸素が使われて二酸化炭素ができること。\n( ｲ ) 燃焼の仕組みについて調べる中で，物が燃えたときの空気の変化について，より妥当な考えをつくりだし，表現すること。,
                  イ 水溶液の性質: ( ｱ ) 次のことを理解するとともに，観察，実験などに関する初歩的な技能を身に付けること。\n㋐ 水溶液には，酸性，アルカリ性及び中性のものがあること。\n㋑ 水溶液には，気体が溶けているものがあること。\n㋒ 水溶液には，金属を変化させるものがあること。\n( ｲ ) 水溶液の性質や働きについて調べる中で，溶けているものによる性質や働きの違いについて，より妥当な考えをつくりだし，表現すること。,
                   ウ てこの規則性: ( ｱ ) 次のことを理解するとともに，観察，実験などに関する初歩的な技能を身に付けること。\n㋐ 力を加える位置や力の大きさを変えると，てこを傾ける働きが変わり，てこがつり合うときにはそれらの間に規則性があること。\n㋑ 身の回りには，てこの規則性を利用した道具があること。\n( ｲ ) てこの規則性について調べる中で，力を加える位置や力の大きさとてこの働きとの関係について，より妥当な考えをつくりだし，表現すること。,
                   エ 電気の利用": ( ｱ ) 次のことを理解するとともに，観察，実験などに関する初歩的な技能を身に付けること。\n㋐ 電気は，つくりだしたり蓄えたりすることができること。\n㋑ 電気は，光，音，熱，運動などに変換することができること。\n㋒ 身の回りには，電気の性質や働きを利用した道具があること。\n( ｲ ) 電気の性質や働きについて調べる中で，電気の量と働きとの関係，発電や蓄電，電気の変換について，より妥当な考えをつくりだし，表現すること。,
                  内容の取扱い (電気の利用)": "カ (2)の「Ｃ物質・エネルギー」のエの「電気の利用」の( ｱ )の㋐については，電気をつくりだす道具として，手回し発電機，光電池などを扱うものとする。\nオ (2)の「Ｃ物質・エネルギー」の指導に当たっては，ものづくりを通して行うよう配慮すること。                
      """},
      "指導計画の作成と内容の取扱い": 
          """指導計画作成上の配慮ア 単元など内容や時間のまとまりを見通して，その中で育む資質・能力の育成に向けて，生徒の主体的・対話的で深い学びの実現を図るようにすること。その際，理科の学習過程の特質を踏まえ，理科の見方・考え方を働かせ，見通しをもって観察，実験を行うなどの，問題を科学的に解決しようとする学習活動の充実を図ること。\nイ ２の各段階で育成を目指す思考力，判断力，表現力等については，当該段階において育成することを目指す力のうち，主なものを示したものであり，実際の指導に当たっては，他の段階で掲げている力の育成についても十分に配慮すること,
      内容の取扱いについての配慮ア 問題を見いだし，予想や仮説，観察，実験などの方法について考えたり説明したりする学習活動，観察，実験の結果を整理し考察する学習活動，科学的な言葉や概念を使用して考えたり説明したりする学習活動などを重視すること。\nイ 観察，実験などの指導に当たっては，指導内容に応じてコンピュータや情報通信ネットワークなどを適切に活用できるようにすること。\nウ 実験を行うに当たっては，身の回りのことや生活に関わるものを取り扱うこと。\nエ 生物，天気，川，土地などの指導に当たっては，野外に出掛け地域の自然に親しむ活動や体験的な活動を多く取り入れるとともに，生命を尊重し，自然環境の保全に寄与する態度を養うようにすること。\nオ 天気，川，土地などの指導に当たっては，災害に関する基礎的な理解が図られるようにすること。\nカ 科学技術が日常生活や社会を豊かにしていることや理科で学習することが様々な職業などと関係していることに触れること。\nキ 個々の生徒が主体的に問題を解決する活動を進めるとともに，日常生活や他教科等との関連を図った学習活動，目的を設定し，計測して制御するという考え方に基づいた学習活動が充実するようにすること。\nク 博物館や科学学習センターなどと連携，協力を図ること。
       """  },  
            "美術科": {
   "目標": """表現及び鑑賞の幅広い活動を通して，造形的な見方・考え方を働かせ，生活や社会の中の美術や美術文化と豊かに関わる資質・能力を次のとおり育成することを目指す。\n（１） 造形的な視点について理解するとともに，表現方法を創意工夫し，創造的に表すことができるようにする。\n（２） 造形的なよさや美しさ，表現の意図と工夫などについて考え，主題を生み出し豊かに発想し構想を練ったり，美術や美術文化などに対する見方や感じ方を深めたりすることができるようにする。\n（３） 美術の創造活動の喜びを味わい，美術を愛好する心情を育み，感性を豊かにし，心豊かな生活を創造していく態度を養い，豊かな情操を培う。""",
    "１段階": {
       "目標": """
    ...
    "指導計画の作成と内容の取扱い": 
      """指導計画作成上の配慮事項: 
        ア: 題材など内容や時間のまとまりを見通して，その中で育む資質・能力の育成に向けて，生徒の主体的・対話的で深い学びの実現を図るようにすること。その際，造形的な見方・考え方を働かせ，表現したり鑑賞したりする資質・能力を相互に関連させた学習の充実を図ること。,
        イ: ２の各段階の内容の「Ａ表現」及び「Ｂ鑑賞」の指導については相互の関連を図り，特に発想や構想に関する資質・能力と鑑賞に関する資質・能力とを総合的に働かせて学習が深められるようにすること。,
        ウ: ２の各段階の内容の〔共通事項〕は，表現及び鑑賞の学習において共通に必要となる資質・能力であり，「Ａ表現」及び「Ｂ鑑賞」の各事項の指導と併せて，十分な指導が行われるよう工夫すること。,
        エ: ２の各段階の内容の「Ｂ鑑賞」の指導に当たっては，作品等について説明したり，話し合ったりして，周りの人と共有できる機会を設けるようにすること。,
        オ: ２の各段階の内容の「Ｂ鑑賞」の指導に当たっては，生徒や学校の実態に応じて，地域の美術館や博物館等と連携を図ったり，それらの施設や文化財などを積極的に活用したりするようにすること。また，学校図書館等における鑑賞用図書，映像資料等の活用を図ること。
      "内容の取扱いと指導上の配慮事項": 
        ア: 「Ａ表現」の指導に当たっては，材料や用具の安全な使い方や保管について指導するとともに，活動場所について事前の点検や安全指導をするなどして，事故防止について徹底すること。,
        イ: 生徒が個性を生かして活動することができるようにするため，学習活動や表現方法などに幅をもたせるようにすること。,
        ウ: 「Ａ表現」の指導に当たっては，活動の全過程を通して生徒が実現したい思いや願いを大切にしながら活動できるようにし，自分のよさや可能性を見いだし，生涯にわたり，楽しく豊かな生活を創造する態度を養うようにすること。,
        エ: 各活動において，互いのよさや個性などを認め尊重し合うようにすること。,
        オ: 互いの個性を生かし合い協力して創造する喜びを味わえるようにするため，適切な機会を選び共同で行う創造活動を経験させること。,
        カ: 「Ａ表現」及び「Ｂ鑑賞」の学習を通して学んだことが，生活や社会の中で生かせるようにすることや，作品や用具等を大切に取り扱うことを理解して使えるよう指導すること。,
        ...
        ス: 創造することの価値に気付き，自分たちの作品や美術作品などに表れている創造性を大切にする態度を養うとともに，必要に応じて，美術に関する知的財産権や肖像権などについて触れるようにすること。また，こうした態度を養うことが，美術文化の継承，発展，創造を支えていることへの理解につながるよう配慮すること。
     """ }, 
            "保健体育科": {
    "目標": """体育や保健の見方・考え方を働かせ，課題を発見し，合理的・計画的な解決に向けた主体的・協働的な学習過程を通して，心と体を一体として捉え，生涯にわたって心身の健康を保持増進し，豊かなスポーツライフを継続するための資質・能力を次のとおり育成することを目指す。
（１） 各種の運動の特性に応じた技能等並びに個人生活及び社会生活における健康・安全についての理解を深めるとともに，目的に応じた技能を身に付けるようにする。
（２） 各種の運動や健康・安全についての自他や社会の課題を発見し，その解決に向けて仲間と思考し判断するとともに，目的や状況に応じて他者に伝える力を養う。
（３） 生涯にわたって継続して運動に親しむことや，健康の保持増進と体力の向上を目指し，明るく豊かで活力ある生活を営む態度を養う。""",
    "１段階": {
      "目標": """
    ...
    "２段階": {
      ...
      "内容": """
        "A 体つくり運動": 
          "ア": 体ほぐしの運動や体の動きを高める運動を通して，体を動かす楽しさや心地よさを深く味わい，その行い方や方法の理解を深めるとともに，仲間と自主的に関わったり，動きを持続する能力などを高める運動をしたりするとともに，それらを組み合わせる,
    ...
    "指導計画の作成と内容の取扱い": 
      """指導計画作成上の配慮事項: 
        "ア": 単元など内容や時間のまとまりを見通して，その中で育む資質・能力の育成に向けて，生徒の主体的・対話的で深い学びの実現を図るようにすること。その際，体育や保健の見方・考え方を働かせ，運動や健康についての自他の課題を見付け，個々の生徒の障害の状態等に応じて，その解決のための活動の充実を図ること。また，運動の楽しさや喜びを味わったり，健康の大切さを実感したりすることができるよう，留意すること。,
        "イ": ２の各段階の内容の「Ａ体つくり運動」，「Ｈ体育理論」及び「Ｉ保健」については，３学年間にわたって取り扱うこと。
      ...
      "内容の取扱いと指導上の配慮事項": 
        ...
        "エ": 「Ａ体つくり運動」から「Ｇダンス」までと「Ｉ保健」との関連を図る指導を工夫すること。,
        "オ": 「Ａ体つくり運動」については，実生活に役立てるため，自分の体力や生活に応じた運動を考えることができるよう指導を工夫すること。,
        "カ": 「Ｄ水泳」については，泳法との関連において指導を行う場合は，水中からのスタート及びターンを取り上げること。,
        "キ": 「Ｅ球技」については，個の能力だけでなく，より集団を意識したゲームを取り扱うものとする。,
        "ク": 「Ｆ武道」については，武道場や用具の確保が難しい場合は指導方法を工夫して行うとともに，安全面に十分留意すること。,
        "ケ": 「Ｈ体育理論」については，オリンピック・パラリンピックなどの国際大会の意義や役割，フェアプレイの精神等に触れるとともに，運動やスポーツを「すること」，「知ること」，「見ること」，「応援すること」などの多様な関わり方についても取り扱うようにすること。,
        "コ": 自然との関わりの深いスキー，スケートや水辺活動などの指導については，生徒の障害の状態等，学校や地域の実態等に応じて積極的に行うようにすること。,
        "サ": 集合，整頓，列の増減，方向転換などの行動の仕方を身に付け，能率的で安全な集団としての行動ができるようにするための指導を行う場合は，「Ａ体つくり運動」から「Ｇダンス」までの領域において適切に行うものとする。,
        "シ": 言語能力を育成する言語活動を重視し，筋道を立てて練習や作戦について話し合う活動や，個人生活における健康の保持増進や回復について話し合う活動などを通して，コミュニケーション能力や思考力の育成を促し，主体的な学習活動の充実を図ること。
      """},

            "職業科": {
                "目標": """職業に係る見方・考え方を働かせ，職業など卒業後の進路に関する実践的・体験的な学習活動を通して，よりよい生活の実現に向けて工夫する資質・能力を次のとおり育成することを目指す。
（１） 職業に関する事柄について理解を深めるとともに，将来の職業生活に係る技能を身に付けるようにする。
（２） 将来の職業生活を見据え，必要な事柄を見いだして課題を設定し，解決策を考え，実践を評価・改善し，表現する力を養う。
（３） よりよい将来の職業生活の実現や地域社会への貢献に向けて，生活を改善しようとする実践的な態度を養う。""",
                "１段階": {
    ...
    "指導計画の作成と内容の取扱い": """
      指導計画作成上の配慮事項: 題材など内容や時間のまとまりを見通して，その中で育む資質・能力の育成に向けて，生徒の主体的・対話的で深い学びの実現を図るようにすること。その際，職業に係る見方・考え方を働かせ，作業や産業現場等における実習など実践的な活動と知識とを相互に関連付けてより深く理解できるようにするとともに，生活や社会の中から問題を見いだして解決策を考え，実践を評価・改善して，新たな課題の解決に向かう過程を重視した学習の充実を図ること。
２の各段階の目標及び内容については，３学年間を見通した全体的な指導計画に基づき，生徒の学習状況を踏まえながら系統的に展開されるように適切に計画すること。その際，中学部の職業・家庭科をはじめとする各教科等とのつながりを重視すること。また，各項目及び各項目に示す事項については，相互に有機的な関連を図り，総合的に展開されるように適切な題材を設定して計画を作成すること。さらに，高等部における家庭科等と関連付けて効果的に指導を行うとともに，持続可能な開発のための教育を推進する視点から他教科等との関連を図ること。
生徒一人一人のキャリア発達を促していくことを踏まえ，発達の段階に応じて望ましい勤労観や職業観を育むとともに，自己に対する理解を深め，自らの生き方を考えて進路を主体的に選択することができるよう，将来の生き方等についても扱うなど，組織的かつ計画的に指導を行うこと。
地域や産業界との連携を図り，校内外の作業や産業現場等における実習の充実を図ること。産業現場等における実習については，作業や就業体験活動等を踏まえ，段階的・系統的に指導するとともに，地域社会への参画や社会貢献の意識が高まるよう計画すること。
      内容の取扱いと指導上の配慮事項: 実習の指導に当たっては，施設・設備の安全・衛生管理に配慮し，学習環境を整備するとともに，火気，用具，材料などの取扱いと事故防止の指導を徹底するものとする。その際，適切な服装や防護眼鏡・防塵マスクの着用等による安全・衛生の確保に努めること。
実際的な知識及び技能を習得し，その理解を深めることで概念が育まれるとともに，働く喜びや仕事のやりがいを実感できるよう，実践的・体験的な学習活動を充実すること。
生徒が習得した知識や技能を生活に活用したり，職業や生活の変化に対応したりすることができるよう，問題解決的な学習を充実させるとともに，家庭や地域，企業などとの連携・協働を図ること。
職業生活に生きて働く実践的な知識や技能及び態度の形成とその活用に重点を置いた指導が行われるように配慮すること。
職業生活に必要な健康管理や余暇については，将来を見据え自立活動と関連させながら具体的に指導すること。
「Ａ職業生活」については，社会科の内容「ア社会参加ときまり」及び「エ産業と生活」などと関連させて指導すること。
「Ｂ情報機器の活用」については，家庭生活における情報機器の取扱い等についても取り上げること。"""
    },

    "家庭科": {
    "目標": """生活の営みに係る見方・考え方を働かせ，衣食住などに関する実践的・体験的な学習活動を通して，よりよい生活の実現に向けて工夫する資質・能力を次のとおり育成することを目指す。\n（１） 家族・家庭の機能について理解を深め，生活の自立に必要な家族・家庭，衣食住，消費や環境等についての基礎的な理解を図るとともに，それらに係る技能を身に付けるようにする。\n（２） 家庭や地域における生活の中から問題を見いだして課題を設定し，解決策を考え，実践を評価・改善し，考えたことを表現するなど，課題を解決する力を養う。\n（３） 家族や地域の人々との関わりを考え，家族の一員として，よりよい生活の実現に向けて，生活を工夫し考えようとする実践的な態度を養う。""",
    "１段階": {
      "目標": """ア 家族・家庭の機能について理解し，生活の自立に必要な家族・家庭，衣食住，消費や環境等についての基礎的な理解を図るとともに，それらに係る技能を身に付けるようにする。\nイ 家庭や地域における生活の中から問題を見いだして課題を設定し，解決策を考え，実践を評価・改善し，考えたことを表現するなど，課題を解決する力を養う。\nウ 家族や地域の人々との関わりを通して，よりよい生活の実現に向けて，生活を工夫し考えようとする実践的な態度を養う。""",
      "内容": """
        "A 家族・家庭生活": 
          "ア 自分の成長と家族": "（ ア ） 自分の成長と家族や家庭生活との関わりが分かり，家庭生活が家族の協力によって営まれていることに気付くこと。\n（ イ ） 家族とのよりよい関わり方について考え，表現すること。",
          "イ 家庭生活での役割と地域との関わり": "（ ア ） 家庭生活において，地域の人々との協力が大切であることに気付くこと。\n（ イ ） 家族と地域の人々とのよりよい関わり方について考え，表現すること。",
          "ウ 家庭生活における健康管理と余暇": "（ ア ） 健康管理や余暇の有効な過ごし方について理解し，実践すること。\n（ イ ） 健康管理や余暇の有効な過ごし方について考え，表現すること。",
          "エ 乳幼児や高齢者などの生活": "（ ア ） 乳幼児や高齢者などの生活の特徴，乳幼児や高齢者などとの関わり方について気付くこと。\n（ イ ） 乳幼児や高齢者などとのよりよい関わり方について考え，表現すること。"
        ,
        "B 衣食住の生活": 
          "ア 食事の役割": "（ ア ） 生活の中で食事が果たす役割について理解すること。\n（ イ ） 健康によい食習慣について考え，工夫すること。",
          "イ 日常食の調理": "（ ア ） 日常生活と関連付け，用途に応じた食品の選択，食品や調理用具等の安全と衛生に留意した管理，材料に適した加熱調理の仕方について知り，基礎的な日常食の調理ができること。\n（ イ ） 基礎的な日常食の調理について，食品の選択や調理の仕方，調理計画を考え，表現すること。",
          "ウ 衣服の選択": "（ ア ） 衣服と社会生活との関わりが分かり，目的に応じた着用，個性を生かす着用及び衣服の適切な選択について理解すること。\n（ イ ） 衣服の選択について考え，工夫すること。",
          "エ 布を用いた製作": "（ ア ） 目的に応じた縫い方及び用具の安全な取扱いについて理解し，適切にできること。\n（ イ ） 目的に応じた縫い方について考え，工夫すること。",
          "オ 住居の基本的な機能と快適で安全な住まい方": "（ ア ） 家族の生活と住空間との関わりや住居の基本的な機能について知ること。\n（ イ ） 家族の安全や快適さを考えた住空間について考え，表現すること。"
        ,
        "C 消費生活・環境": 
          "ア 消費生活": "（ ア ） 次のような知識及び技能を身に付けること。\n㋐ 購入方法や支払方法の特徴が分かり，計画的な金銭管理の必要性に気付くこと。\n㋑ 売買契約の仕組み，消費者被害の背景とその対応について理解し，物資・サービスの選択に必要な情報の収集・整理ができること。\n（ イ ） 物資・サービスの選択に必要な情報を活用して購入について考え，表現すること。",
          "イ 消費者の基本的な権利と責任": "（ ア ） 消費者の基本的な権利と責任，自分や家族の消費生活が環境や社会に及ぼす影響について気付くこと。\n（ イ ） 身近な消費生活について，自立した消費者として責任ある消費行動を考え，表現すること。"
        
      
    """},
    "２段階": {
      "目標": """ア 家族・家庭の機能について理解を深め，生活の自立に必要な家族・家庭，衣食住，消費や環境等についての基礎的な理解を図るとともに，それらに係る技能を身に付けるようにする。\nイ 家庭や地域における生活の中から問題を見いだして課題を設定し，解決策を考え，実践を評価・改善し，考えたことを表現するなど，課題を解決する力を養う。\nウ 家族や地域の人々との関わりを通して，よりよい生活の実現に向けて，生活を工夫し考えようとする実践的な態度を養う。""",
      "内容": """
        "A 家族・家庭生活": 
          "ア 自分の成長と家族": "（ ア ） 自分の成長と家族や家庭生活の関わりが分かり，家庭生活が家族の協力によって営まれていることを理解すること。\n（ イ ） 家族とのよりよい関わり方について考え，工夫すること。",
          "イ 家庭生活での役割と地域との関わり": "（ ア ） 家庭生活において，地域の人々との協力が大切であることを理解すること。\n（ イ ） 家族と地域の人々とのよりよい関わり方について考え，工夫すること。",
          "ウ 家庭生活における健康管理と余暇": "（ ア ） 健康管理や余暇の有効な過ごし方について理解を深め，実践すること。\n（ イ ） 健康管理や余暇の有効な過ごし方について考え，工夫すること。",
          "エ 乳幼児や高齢者などの生活": "（ ア ） 乳幼児や高齢者などの生活の特徴が分かり，乳幼児や高齢者などとの関わり方について理解すること。\n（ イ ） 乳幼児や高齢者などとのよりよい関わり方について考え，工夫すること。"
        ,
        "B 衣食住の生活": 
          "ア 必要な栄養を満たす食事": "（ ア ） 自分に必要な栄養素の種類と働きが分かり，食品の栄養的な特質について理解すること。\n（ イ ） 一日分の献立について考え，工夫すること。",
          "イ 日常食の調理": "（ ア ） 日常生活と関連付け，用途に応じた食品の選択，食品や調理用具等の安全と衛生に留意した管理，材料に適した加熱調理の仕方について理解し，基礎的な日常食の調理が適切にできること。\n（ イ ） 基礎的な日常食の調理について，食品の選択や調理の仕方，調理計画を考え，工夫すること。",
          "ウ 衣服の手入れ": "（ ア ） 衣服の材料や状態に応じた日常着の手入れについて理解し，適切にできること。\n（ イ ） 衣服の材料や状態に応じた日常着の手入れについて考え，工夫すること。",
          "エ 布を用いた製作": "（ ア ） 製作に必要な材料や手順が分かり，製作計画について理解すること。\n（ イ ） 布を用いた簡単な物の製作計画を考え，製作を工夫すること。",
          "オ 住居の基本的な機能と快適で安全な住まい方": "（ ア ） 家族の生活と住空間との関わりが分かり，住居の基本的な機能について理解すること。\n（ イ ） 家族の安全や快適さを考えた住空間の整え方について考え，工夫すること。"
        ,
        "C 消費生活・環境": 
          ...
          "イ 消費者の基本的な権利と責任": "（ ア ） 消費者の基本的な権利と責任，自分や家族の消費生活が環境や社会に及ぼす影響について理解すること。\n（ イ ） 身近な消費生活について，自立した消費者として責任ある消費行動を考え，工夫すること。"
        
      
    """},
    "指導計画の作成と内容の取扱い": {
      "指導計画作成上の配慮事項": "ア 題材など内容や時間のまとまりを見通して，その中で育む資質・能力の育成に向けて，生徒の主体的・対話的で深い学びの実現を図るようにすること。その際，生活の営みに係る見方・考え方を働かせ，体験的な活動と知識とを相互に関連付けてより深く理解するとともに，生活の中から問題を見いだして解決策を考え，実践を評価・改善して，新たな課題の解決に向かう過程を重視した学習の充実を図ること。\nイ 各段階における目標・内容については，３学年間を見通した全体的な指導計画に基づき，生徒の学習状況を踏まえながら系統的に指導ができるようにすること。その際，中学部の職業・家庭科をはじめとする各教科等とのつながりを重視すること。また，各項目及び各項目に示す事項については，相互に有機的な関連を図り，総合的に展開されるよう適切な題材を設定して計画を作成すること。さらに，高等部における職業科等と関連付けて効果的に指導を行うとともに，他教科等との連携も図ること。\nウ 「Ｂ衣食住の生活」の２段階の「ア必要な栄養を満たす食事」及び「ウ衣服の手入れ」については，それぞれ１段階の「ア食事の役割」及び「ウ衣服の選択」の内容を十分に踏まえるとともに，各段階に示された事項の関連を図りながら，総合的に指導するよう計画すること。\nエ 家庭や地域との連携を図り，校内外での実践的・体験的な学習活動の充実を図り指導の効果を高めること。実践的・体験的な学習活動については，校内での体験的な学習活動と関連させ，段階的・系統的に指導するよう配慮すること。",
      "内容の取扱いと指導上の配慮事項": "ア 指導に当たっては，衣食住などに関する実習等の結果を整理し考察する学習活動や，生活や社会における課題を解決するために言葉や図表，概念などを用いて考えたり，説明したりするなどの学習活動の充実を図ること。\nイ 指導に当たっては，コンピュータや情報通信ネットワークを積極的に活用して，実習等における情報の収集・整理や，実践結果の発表などを行うことができるように工夫すること。\nウ 資質・能力の育成を図り，一人一人の個性を生かし伸ばすよう，生徒の興味・関心を踏まえた学習課題の設定，技能の習得状況に応じた指導や教材・教具の工夫など個に応じた指導の充実に努めること。\nエ 生徒が，学習した知識及び技能を生活に活用したり，生活や社会の変化に対応したりすることができるよう，生活や社会の中から問題を見いだして課題を設定し解決する学習活動を充実するとともに，家庭や地域社会，企業などとの連携を図るように配慮すること。\nオ 「Ｂ衣食住の生活」については，日本の伝統的な生活についても扱い，生活文化を継承する大切さに気付くことができるよう配慮すること。また，「Ｂ衣食住の生活」の各段階の「イ日常食の調理」については，地域の食文化や和食についても取り上げること。\nカ 「Ｃ消費生活・環境」のア及びイについては，「Ａ家族・家庭生活」又は「Ｂ衣食住の生活」の学習との関連を図り，実践的に学習できるようにすること。また，アについては，身近な消費行動と関連を図った物資・サービスや消費者被害を扱うこと。（ ア ）の㋐については，クレジットなどの三者間契約についても扱うこと。",
      "実習などの指導": "ア 施設・設備の安全管理に配慮し，学習環境を整備するとともに，火気，用具，材料などの取扱いに注意して事故防止の指導を徹底し，安全と衛生に十分留意するものとする。その際，服装を整え，衛生に留意して用具の手入れや保管を適切に行うこととする。\nイ 食に関する指導については，家庭科の特質に応じて，食育の充実に資するようにすること。\nウ 乳幼児や高齢者などと関わるなど校外での学習について，事故の防止策及び事故発生時の対応策等を綿密に計画するとともに，相手に対する配慮にも十分留意すること。\nエ 調理に用いる食品については，安全・衛生に留意すること。また，食物アレルギーについても配慮すること。"
    }
  },
         "外国語科": {
    "目標": """外国語によるコミュニケーションにおける見方・考え方を働かせ，外国語による聞くこと，読むこと，話すこと，書くことの言語活動を通して，コミュニケーションを図る基礎となる資質・能力を次のとおり育成することを目指す。\n（１） 外国語の音声や文字，語彙，表現，言語の働きなどについて，日本語と外国語との違いに気付くとともに，読むこと，書くことに慣れ親しみ，聞くこと，読むこと，話すこと，書くことによる実際のコミュニケーションにおいて活用できる基礎的な技能を身に付けるようにする。\n（２） コミュニケーションを行う目的や場面，状況などに応じて，身近で簡単な事柄について，聞いたり話したりするとともに，音声で十分に慣れ親しんだ外国語の語彙などが表す事柄を想像しながら読んだり書いたりして，自分の考えや気持ちなどを伝え合うことができる基礎的な力を養う。\n（３） 外国語の背景にある文化に対する理解を深め，他者に配慮しながら，主体的に外国語を用いてコミュニケーションを図ろうとする態度を養う。""",
    "１段階": {
      "目標": """
        "知識及び技能に関する目標": ア 音声や文字，語彙，表現などについて日本語と外国語との違いに気付くとともに，読むこと，書くことに慣れ親しみ，聞くこと，話すことを中心とした実際のコミュニケーションにおいて活用できる基礎的な力を身に付けるようにする。
        "思考力，判断力，表現力等に関する目標": イ コミュニケーションを行う目的や場面，状況などに応じて，身近で簡単な事柄について，聞いたり話したりするとともに，音声で十分に慣れ親しんだ外国語の語彙などを真似ながら読んだり，外国語の文字をなぞって書いたりして，自分の考えや気持ちなどを伝え合うことができる基礎的な力を養う。
        "学びに向かう力，人間性等の涵養に関する目標": ウ 外国語の背景にある文化について理解し，相手に配慮しながら，主体的に外国語を用いてコミュニケーションを図ろうとする態度を養う。""",
      "内容": """
        "英語": 
          "知識及び技能": 
            "英語の特徴等に関する事項": ア 実際に英語を用いた場面や状況等における言語活動を通して，次の事項を身に付けることができるよう指導する。\n（ ア ） 英語の音声及び簡単な語句や基本的な表現などについて，日本語との違いに気付くこと。\n㋐ 英語の音声を聞いて話したり，文字を見て読んだり書いたりして日本語の音声や文字などとの違いに気付くこと。\n㋑ 英語の音声や文字も，事物の内容を表したり，要件を伝えたりするなどの働きがあることに気付くこと。\n㋒ 簡単な語句や基本的な表現などが表す内容を知り，それらを使うことで要件が相手に伝わることに気付くこと。
          "思考力，判断力，表現力等": 
            "情報を整理しながら考えなどを形成し，英語で表現したり，伝え合ったりすることに関する事項": イ 具体的な課題等を設定し，コミュニケーションを行う目的や場面，状況などに応じて，情報を整理しながら考えなどを形成し，これらを表現することを通して，次の事項を身に付けることができるよう指導する。\n（ ア ） 簡単な事柄について，伝えようとした内容を整理した上で，簡単な語句などを用いて自分の考えや気持ちなどを伝え合うこと。\n（ イ ） 身近で簡単な事柄について，音声で十分に慣れ親しんだ簡単な語彙などが表す事柄を想像しながら読んだり，書いたりすること。
          "言語活動及び言語の働きに関する事項": 
            "言語活動に関する事項": ウ イに示す事項については，アに示す事項を活用して，例えば，次のような言語活動を通して指導する。\n（ ア ） 聞くこと\n㋐ 自分に関する簡単な事柄について，簡単な語句や基本的な表現を聞き，それらを表すイラストや写真などと結び付ける活動。\n㋑ 日付や時刻，値段などを表す表現など，身近で簡単な事柄について，表示などを参考にしながら具体的な情報を聞き取る活動\n（ イ ） 話すこと［発表］\n㋐ 簡単な語句や基本的な表現を用いて，自分の趣味や得意なことなどを含めて自己紹介をする活動。\n（ ウ ） 話すこと［やり取り］\n㋐ 挨拶を交わしたり，簡単な指示や依頼をして，それらに応じたり断ったりする活動。\n（ エ ） 書くこと\n㋐ 活字体の大文字，小文字を区別して書く活動。\n㋑ 相手に伝えるなどの目的をもって，身近で簡単な事柄について，音声で十分に慣れ親しんだ簡単な語彙などを書き写す活動。\n㋒ 相手に伝えるなどの目的をもって，身近で簡単な事柄について，音声で十分に慣れ親しんだ語彙などを書き写す活動。\n（ オ ） 読むこと\n㋐ 活字体で書かれた文字を見て，どの文字であるかやその文字が大文字であるか小文字であるかを識別する活動。\n㋑ 活字体で書かれた文字を見て，その読み方を発音する活動。
    ...
    "２段階": {
      "目標": """
        "知識及び技能に関する目標": ア 音声や文字，語彙，表現などについて日本語と外国語との違いに気付くとともに，読むこと，書くことに慣れ親しみ，聞くこと，話すこと，読むこと，書くことによる実際のコミュニケーションにおいて活用できる基礎的な力を身に付けるようにする。
        "思考力，判断力，表現力等に関する目標": イ コミュニケーションを行う目的や場面，状況などに応じて，身近で簡単な事柄について，聞いたり話したりするとともに，音声で十分に慣れ親しんだ外国語の語彙などが表す事柄を想像しながら読んだり書いたりして，自分の考えや気持ちなどを伝え合うことができる基礎的な力を養う。
        "学びに向かう力，人間性等の涵養に関する目標": ウ 外国語の背景にある文化について理解し，他者に配慮しながら，主体的に外国語を用いてコミュニケーションを図ろうとする態度を養う。""",
      "内容": """
        "英語": 
          "知識及び技能": 
          ...
          "言語活動及び言語の働きに関する事項": 
            "言語活動に関する事項": ウ イに示す事項については，アに示す事項を活用して，例えば，次のような言語活動を通して指導する。\n（ ア ） 聞くこと\n㋐ 自分のことや学校生活など身近で簡単な事柄について，簡単な語句や基本的な表現を聞き，それらを表すイラストや写真などと結び付ける活動。\n㋑ 日付や時刻，値段などを表す表現など，身近で簡単な事柄について，具体的な情報を聞き取る活動。\n㋒ 友達や家族，学校生活など，身近で簡単な事柄について，簡単な語句や基本的な表現で話される短い会話や説明を，イラストや写真を参考にしながら聞いて，必要な情報を聞き取る活動。\n（ イ ） 話すこと［発表］\n㋐ 簡単な語句や基本的な表現を用いて，身近で簡単な事柄について，自分の考えや気持ちを話す活動。\n（ ウ ） 話すこと［やり取り］\n㋐ 身近で簡単な事柄について，自分の考えや気持ちを伝えたり，簡単な質問をしたり質問に答えたりして伝え合う活動。\n（ エ ） 書くこと\n㋐ 相手に伝えるなどの目的をもって，身近で簡単な事柄について，音声で十分に慣れ親しんだ語彙などを書き写す活動。\n㋑ 相手に伝えるなどの目的をもって，身近で簡単な事柄について，音声で十分に慣れ親しんだ簡単な語彙などを書く活動。\n（ オ ） 読むこと\n㋐ 日常生活に関する身近で簡単な事柄を内容とする掲示やパンフレットなどから，自分が必要とする情報を得る活動。\n㋑ 音声で十分に慣れ親しんだ簡単な語彙などを，挿絵がある本などの中から識別する活動。
            "言語の働きに関する事項": ② ２段階の言語活動を行うに当たり，１段階の言語の働きに関する事項を踏まえ，生徒の学習状況に応じた言語の使用場面や言語の働きを取り上げるようにする。
        "その他の外国語": その他の外国語については，〔英語〕に示す内容に準じて指導を行うものとする。
      
    """},
    "指導計画の作成と内容の取扱い": {
      """外国語科における英語の履修: （１） 外国語科においては，英語を履修させることを原則とすること。
      指導計画作成上の配慮事項: ア 単元など内容や時間のまとまりを見通して，その中で育む資質・能力の育成に向けて，生徒の主体的・対話的で深い学びの実現を図るようにすること。その際，具体的課題等を設定し，生徒が外国語によるコミュニケーションにおける見方・考え方を働かせながら，コミュニケーションの目的や場面，状況などを意識して活動を行い，英語の音声や語彙，表現などの知識を，五つの領域における実際のコミュニケーションにおいて活用する学習の充実を図ること。\nイ これまでに学習した外国語との関連に留意して，指導計画を適切に作成すること。\nウ 外国語科を設ける場合は，生徒の障害の状態や実態に応じて，指導目標を適切に定め，３年間を通して外国語科の目標の実現を図るようにすること。\nエ 指導内容や活動については，生徒の興味や関心，経験などに合ったものとし，他の教科等で学習したことを活用したり，学校行事で扱う内容と関連付けたりするなどの工夫により，指導の効果を高めるようにすること。\nオ 指導計画の作成や授業の実施に当たっては，ネイティブ・スピーカーや英語が堪能な地域人材などの協力を得る等，指導体制等の充実を図るとともに，指導方法の工夫を行うこと。\nカ 外国語を通して他者とコミュニケーションを図ることの必要性や楽しさを味わうことができるよう工夫すること。
      内容の取扱いについての配慮事項: ア 言語材料については，生徒に身近で簡単なものから扱うようにするとともに，語句，連語及び慣用表現については活用頻度の高いものを用い，必要に応じて繰り返し活用しながら体験的な理解を図るようにすること。\nイ １段階のウの②に示す事項については，２段階においても指導すること。\nウ 生徒の実態や教材の内容などに応じて，情報機器等を有効に活用し適切な言語材料を十分に提供できるようにすること。"""
    }
}
}
}
